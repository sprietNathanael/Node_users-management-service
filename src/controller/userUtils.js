class UserUtils {
	...
	/**
	 * Check the format of a user where attributes can not be undefined
	 * @param {String} lastname
	 * @param {String} firstname
	 * @param {String} username
	 * @param {String} password
	 */
	checkUserFormatMandatory(lastname, firstname, username, password) {
		...
		return this.checkUserFormat(lastname, firstname, username, password);
	}
	...
	checkPassword(password) {
		...
		if (typeof password !== 'string') {
			throw new TypeError(`${typeof password} is not a string`);
		}
