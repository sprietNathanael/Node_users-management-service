...
var checkNameTester = new FunctionWithReturnTester(userUtils.checkName, [{type:nameParameterType,name:"name"}], {"0":false}, true, userUtils);
...
var checkUsernameTester = new FunctionWithReturnTester(userUtils.checkUsername, [{type:usernameParameterType,name:"username"}],{"0":false}, true,userUtils);
...
var checkPasswordTester = new FunctionWithReturnTester(userUtils.checkPassword, [{type:passwordParameterType,name:"password"}], {"0":false}, true,userUtils);

var checkUserFormatTester = new FunctionWithReturnTester(userUtils.checkUserFormat, [
    {type:nameParameterType,name:"lastname"},
    {type:nameParameterType,name:"firstname"},
    {type:usernameParameterType,name:"username"},
    {type:passwordParameterType,name:"password"}], {
        "0":"lastname",
